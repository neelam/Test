...
class userprofile
{
	public function userprofile() {
		...
		if(isset($_POST['__EVENTTARGET']) && $_POST['__EVENTTARGET'] == 'update_profile')
			$this->updateUserprofile();
		if(isset($_POST['__EVENTTARGET']) && $_POST['__EVENTTARGET'] == 'do_suspended')
			$this->doSuspended();
		  ...
		  && isset($_REQUEST['who']) && !empty($_REQUEST['who']))
		{
			...
			$this->userInfo->setUserid($_REQUEST['who']);
