...
$SESS_DBHOST = $config->db_host;			/* database server hostname */
$SESS_DBNAME = $config->db_name;			/* database name */
$SESS_DBUSER = $config->db_user;		/* database user */
$SESS_DBPASS = $config->db_password;		/* database password */
...
function setValue()
{
	...
	if(empty($SESS_DBHOST)) $SESS_DBHOST = $config->db_host;
	if(empty($SESS_DBNAME)) $SESS_DBNAME = $config->db_name;
	if(empty($SESS_DBUSER)) $SESS_DBUSER = $config->db_user;
	if(empty($SESS_DBPASS)) $SESS_DBPASS = $config->db_password;
}
